...
from agent.tools.network_tools import check_website, get_domain_info


class NetworkToolsTest(unittest.TestCase):
    @patch("agent.tools.network_tools.requests.head")
    ...
    @patch("agent.tools.network_tools.dns.resolver.Resolver.resolve")
